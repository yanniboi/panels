...
/**
 * @file
 * Contains Drupal\panels\Entity\DisplayVariantInterface.
 */
...
/**
 * Provides an interface defining a DisplayVariant entity.
 */
interface DisplayVariantInterface extends ConfigEntityInterface, EntityWithPluginCollectionInterface {
   ...
   *
   * @return \Drupal\panels\Entity\DisplayInterface
   */
   ...
   *
   * @param \Drupal\panels\Entity\DisplayInterface $display_entity
  ...
  /**
   * Gets the weight of this variant (compared to other variants on the display
   * entity).
   *
   * @return int
   */
  ...
  /**
   * Sets the weight of this variant (compared to other variants on the display
   * entity).
   *
   * @param int $weight
   *   The weight of the variant.
  ...
  /**
   * Returns the static context configurations for this display entity.
   *
   * @return array[]
