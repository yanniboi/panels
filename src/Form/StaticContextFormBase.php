...
/**
 * @file
 * Contains \Drupal\panels\Form\StaticContextFormBase.
 */
...
abstract class StaticContextFormBase extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, DisplayVariantInterface $display_variant = NULL, $name = '') {
    ...
    $this->staticContext = $this->displayVariant->getStaticContext($name);
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->displayVariant->setStaticContext($form_state->getValue('machine_name'), $this->staticContext);
  ...
  public function contextExists($name) {
    return isset($this->displayVariant->getContexts()[$name]);
  }
