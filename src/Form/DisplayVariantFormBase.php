...
/**
 * @file
 * Contains Drupal\panels\Form\DisplayVariantFormBase.
 */
 ...
 */
abstract class DisplayVariantFormBase extends EntityForm {
  ...
  /**
   * The variant plugin for this display variant entity.
   *
  ...
  /**
   * Construct a new DisplayVariantFormBase.
   *
  ...
  /**
   * Determines if the display variant entity already exists.
   *
   * @param string $id
   *   The display variant entity ID.
   *
   * @return bool
