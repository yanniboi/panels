...
/**
 * @file
 * Contains \Drupal\panels\Form\VariantPluginAddBlockForm.
 */
...
class VariantPluginAddBlockForm extends VariantPluginConfigureBlockFormBase {
  ...
  public function getFormId() {
    return 'entity_display_variant_add_block_form';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, Request $request = NULL, DisplayVariantInterface $display_variant = NULL, $block_id = NULL) {
    $form = parent::buildForm($form, $form_state, $display_variant, $block_id);
